...
- **Sonuçları Kopyalama**: Analiz sonuçlarını panoya kopyalama
...
├── index.html                    # Web tanıtım sayfası
│
...
│   ├── history.txt               # Analiz geçmişi
│   ├── cache/                    # Cache klasörü
│   │   ├── usom_cache.txt        # USOM cache
│   │   └── analysis/             # Analiz cache
...
│
├── dist/                         # Derlenmiş executable
│   └── ClickProtection.exe       # Windows executable
│
└── docs/                         # Dokümantasyon
    ├── README.md                 # Bu dosya
